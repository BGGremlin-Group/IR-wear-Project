...
pio run -e pico
pio run -e nano
pio run -e stm32_bluepill

# Upload to connected device
pio run -e esp32dev -t upload --upload-port /dev/ttyUSB0

# Monitor serial output
pio device monitor -e esp32dev -p /dev/ttyUSB0
...
- ESP32: Uses CP210x UART, auto-reset works
- Pico: Press BOOTSEL button, drops UF2 to RPI-RP2 drive
- Nano: Uses FTDI/CH340 UART, may need manual reset
- STM32: Requires ST-Link V2 programmer (SWD)
