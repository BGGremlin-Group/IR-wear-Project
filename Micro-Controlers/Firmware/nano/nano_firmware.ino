/*
 * nano_firmware.ino
 * IRWP v2.5 - Arduino Nano Version
 * Compile with Arduino IDE (select Arduino Nano, ATmega328P)
 */
...
// Pin Definitions (Nano pins)
#define HAT_PIN     3   // PWM pin
#define HOODIE_PIN  5   // PWM pin
#define PANTS_PIN   6   // PWM pin
#define SHOES_PIN   9   // PWM pin
#define SAFETY_PIN  2
...
// Built-in Patterns (stored in PROGMEM)
const PROGMEM AttackPattern PROVEN_PATTERNS[] = {
  {
    "AGC_Lock_5_Second", 9,
...
void setup() {
  ...
  Serial.println("Nano Firmware Initialized");
}
