/*
 * pico_firmware.cpp
 * IRWP v2.5 - Raspberry Pi Pico Version
 * Compile with Arduino IDE (select Raspberry Pi Pico) or Pico SDK
 */
...
#define HAT_PIN     16
#define HOODIE_PIN  17
#define PANTS_PIN   18
#define SHOES_PIN   19
#define SAFETY_PIN  20
#define EMERGENCY_PIN 21
#define RELAY_PIN   22
...
void setup() {
  ...
  Serial.println("Pico Firmware Initialized");
}
...
void processCommand(String cmd) {
  if (cmd == "ARM") {
    ...
    // Parse JSON-like: SET_GROUP:{"group":0,"intensity":255}
    int group_start = cmd.indexOf(':') + 1;
    String json_str = cmd.substring(group_start);
    // Simple parser for this format
